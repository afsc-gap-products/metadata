...
> The code is in development. To make edits to the README, please instead edit the [README.qmd](`r paste(link_repo, "blob/main/README.md")`) file. 
...
-   For more information about codes used in the tables, please refer to the [survey code books](`r INSERT_CODE_BOOK `) [@cb2021].
...
Find the `GAP_PRODUCTS.METADATA_COLUMN` and `GAP_PRODUCTS.METADATA_TABLE` in oracle for the tables above. Check out the `functions_oracle.R` script for funtions for downloading or uploading data to oracle. 
